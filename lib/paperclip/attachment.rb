module Paperclip
  ...
  class Attachment
    ...
    # If <attachment> is an image and <attachment>_width attribute is
    # present, returns the original width of the image when no
    # argument is specified or the calculated new width of the image
    # when passed a valid style. Returns nil otherwise
    def width style = default_style
      dimensions(style)[0]
    end

    # If <attachment> is an image and <attachment>_height attribute is
    # present, returns the original width of the image when no
    # argument is specified or the calculated new height of the image
    # when passed a valid style. Returns nil otherwise
